...
<body> 
    <?= form_open_multipart('konten/simpan'); ?>
    ...
    <select name="id_kategori" id="">
        ...
        <label for="">Tanggal</label>
            <input type="date" class="form-control" 
                name = "tanggal" placeholder="Password">
        ...
        <input type="text" id="audio_url" name="audio_url" placeholder="Masukkan URL audio">
       
        </div>

        <div class="form-floating mb-3">
        <label for="">OST</label>
        <input type="text" id="ost" name="ost" placeholder="Masukkan URL ost">
       
        </div>

        <div class="form-floating mb-3">
        <label for="">Audio</label>
        <input type="file" id="audio" name="audio" placeholder="Masukkan URL audio">
